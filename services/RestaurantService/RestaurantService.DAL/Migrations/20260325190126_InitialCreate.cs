        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileUrl = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StopListItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StopListItems_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StopListItems_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_RestaurantId_Address",
                table: "Locations",
                columns: new[] { "RestaurantId", "Address" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StopListItems_LocationId",
                table: "StopListItems",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_StopListItems_MenuItemId",
                table: "StopListItems",
                column: "MenuItemId");
        }
